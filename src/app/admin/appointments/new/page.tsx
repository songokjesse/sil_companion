import { getAllParticipantsAdmin, createAppointment } from "@/lib/actions";
    ...
    <div className="space-y-6 max-w-4xl mx-auto py-10">
      <div className="flex flex-col gap-4">
        <Link 
          ...
          className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors w-fit"
        >
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 flex items-center gap-2">
            ...
            Schedule an external engagement requiring staff tracking
          </p>
        </div>
      </div>
      ...
      <form action={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label htmlFor="title" className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
                  <AlignLeft className="h-3 w-3" /> Event Title *
                </label>
                <input
                  type="text"
                  id="title"
                  name="title"
                  required
                  placeholder="e.g. Dr. Smith Consult"
                  className="w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-900 focus:border-indigo-400 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 text-slate-800 dark:text-slate-100"
                />
              </div>
              ...
              <div className="space-y-2">
                <label htmlFor="type" className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
                  <Calendar className="h-3 w-3" /> Event Category
                </label>
                <select
                  id="type"
                  name="type"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  name="dateTime"
                  required
                  className="w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-900 focus:border-indigo-400 transition-all text-slate-800 dark:text-slate-100"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  placeholder="e.g. 123 Health Clinic, Metro Suburb"
                  className="w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-900 focus:border-indigo-400 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 text-slate-800 dark:text-slate-100"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="space-y-4">
                  <label className="flex items-center gap-3 rounded-xl border border-indigo-200/60 dark:border-indigo-900/40 bg-indigo-50/60 dark:bg-indigo-950/20 p-4 cursor-pointer hover:bg-indigo-100/50 dark:hover:bg-indigo-950/40 transition-colors w-full h-full min-h-[50px]">
                     <input
                       type="checkbox"
                       id="transportReq"
                       name="transportReq"
                       className="h-4 w-4 rounded border-indigo-300 dark:border-indigo-700 text-indigo-600 focus:ring-indigo-200 dark:focus:ring-indigo-900"
                     />
                     <div className="flex flex-col">
                        <span className="text-[11px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400 flex items-center gap-1.5">
                          <Car className="h-3 w-3" /> Requires Transportation
                        </span>
                        <span className="text-[10px] font-bold text-indigo-500/80 dark:text-indigo-500/80">Staff logistics coordination needed</span>
                     </div>
                  </label>
                  ...
                  <input
                    ...
                    id="transportNotes"
                    name="transportNotes"
                    placeholder="Transport logistics/notes (if required)"
                    className="w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-900 focus:border-indigo-400 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 text-slate-800 dark:text-slate-100"
                  />
               </div>

               <div className="space-y-4">
                  <label className="flex items-center gap-3 rounded-xl border border-slate-200/60 dark:border-slate-800/60 bg-slate-50/60 dark:bg-slate-900/40 p-4 cursor-pointer hover:bg-slate-100/50 dark:hover:bg-slate-900 transition-colors w-full h-full min-h-[50px]">
                     <input
                       type="checkbox"
                       id="escortReq"
                       name="escortReq"
                       className="h-4 w-4 rounded border-slate-300 dark:border-slate-700 text-purple-600 focus:ring-purple-200 dark:focus:ring-purple-900"
                     />
                     <div className="flex flex-col">
                        <span className="text-[11px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-400 flex items-center gap-1.5">
                          <ShieldCheck className="h-3 w-3" /> Staff Escort Required
                        </span>
                        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500">Requires 1:1 support presence</span>
                     </div>
                  </label>
                  ...
                  <textarea
                    ...
                    name="prepNotes"
                    rows={2}
                    placeholder="Preparation notes (What to bring, context)"
                    className="w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-900 focus:border-indigo-400 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 text-slate-800 dark:text-slate-100"
                  />
               </div>
            </div>
        ...
        <div className="flex justify-end pt-4">
          <button
            type="submit"
            className="flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-4 text-xs font-black uppercase tracking-widest text-white transition-all hover:bg-indigo-700 shadow-lg shadow-indigo-200 dark:shadow-none hover:-translate-y-0.5"
          >
