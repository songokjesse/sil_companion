    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
         <div className="space-y-1">
            <h1 className="text-3xl font-black tracking-tight text-slate-800 dark:text-slate-100">Resident Registry</h1>
         ...
         <div className="flex gap-2">
            <Button variant="outline" className="font-bold border-slate-200 dark:border-slate-800">
      ...
      <div className="rounded-2xl border bg-white dark:bg-slate-950 shadow-sm overflow-hidden">
         <Table>
            <TableHeader className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800/60">
               <TableRow>
            ...
            <TableBody>
               {participants.map((p) => (
                  <TableRow key={p.id} className="hover:bg-slate-50 dark:bg-slate-900 transition-colors border-b border-slate-100 dark:border-slate-800/50/50">
                     ...
                     <TableCell className="px-6">
                        <div className="flex items-center gap-2 font-bold text-[11px] uppercase tracking-widest text-slate-600 dark:text-slate-300 bg-slate-100 px-3 py-1.5 rounded-lg w-fit">
                           {p.house.name}
                        </div>
                     </TableCell>
                     <TableCell className="px-6">
                        <div className="flex flex-wrap gap-2 max-w-[200px]">
                            <Badge variant="outline" className="text-[9px] font-black border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-500 dark:text-slate-400 uppercase tracking-widest px-2.5 py-1">
                     ...
                     <TableCell className="px-6">
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-300 mt-0.5">Synced</span>
                        </div>
                     </TableCell>
