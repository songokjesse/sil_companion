          ...
          <Link key={stat.title} href={stat.href}>
            <Card className="group border-none shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">{stat.title}</CardTitle>
              ...
              <CardContent>
                <div className="text-4xl font-black text-slate-800 dark:text-slate-100 tabular-nums">{stat.value}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-4">
         <Card className="border-none shadow-sm">
            ...
            <CardContent className="grid grid-cols-2 gap-4">
               <button className="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900 border-2 border-transparent hover:border-purple-200 hover:bg-white dark:bg-slate-950 transition-all gap-2 group">
                  <Building2 className="h-6 w-6 text-purple-600 group-hover:scale-110 transition-transform" />
                  <span className="text-xs font-black uppercase tracking-widest text-slate-600 dark:text-slate-300">Add House</span>
               </button>
               <button className="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900 border-2 border-transparent hover:border-purple-200 hover:bg-white dark:bg-slate-950 transition-all gap-2 group">
                  <Users className="h-6 w-6 text-purple-600 group-hover:scale-110 transition-transform" />
                  <span className="text-xs font-black uppercase tracking-widest text-slate-600 dark:text-slate-300">Register Resident</span>
               </button>
            </CardContent>
         </Card>
            ...
            <CardContent>
               <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm p-3 rounded-xl bg-green-50/50 border border-green-100/50">
                     <span className="font-bold text-slate-600 dark:text-slate-300">Database Sync</span>
                  ...
                  <div className="flex items-center justify-between text-sm p-3 rounded-xl bg-purple-50/50 border border-purple-100/50">
                     <span className="font-bold text-slate-600 dark:text-slate-300">Auth Engine</span>
